    ...
    <div className="absolute -bottom-2 -right-2 w-8 h-8 bg-green-500 rounded-full border-4 border-white dark:border-gray-800"></div>
          ...
          <div className="space-y-6">
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold text-gray-900 dark:text-white">
              Hi, My name is <span className="bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">Amirul Shafiq</span>
            </h1>
            
            <div className="h-8 md:h-12 flex items-center justify-center">
              <h2 className="text-xl md:text-3xl lg:text-4xl font-semibold text-gray-700 dark:text-gray-300 transition-all duration-500">
                {texts[currentText]}
              </h2>
            </div>

            <p className="text-lg md:text-xl text-gray-600 dark:text-gray-400 max-w-3xl mx-auto leading-relaxed">
              Fresh Computer Science graduate passionate about software development and creating innovative solutions. 
              Eager to start my career and contribute to meaningful projects while continuing to learn and grow.
            </p>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            ...
            <button
              ...
              className="px-8 py-4 border-2 border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 font-semibold rounded-lg hover:border-blue-600 dark:hover:border-blue-400 hover:text-blue-600 dark:hover:text-blue-400 transform hover:scale-105 transition-all duration-200"
            >
              Get In Touch
            </button>
          </div>
          ...
          <div className="flex justify-center space-x-6 pt-8">
            <a
              href="https://github.com/amr-shafiq"
              target="_blank"
